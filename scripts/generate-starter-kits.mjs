...
const KIT_CONFIG = {
  ...
  'Full Starter': { id: 'full-starter', name: 'Full Starter Pack', price: 167.45, choose: 10, chooseLabel: 'colours', tagline: 'Choose 10 colours, 1× Liquid Polygel Clear, 1× BIAB Clear, 1 Dual Forms box, 1× Premium Builder Gel & 1 Multimix · standard items included', infoKeys: [], groups: [{ key: 'dualforms', label: 'Choose 1 box of Dual Form tips', choose: 1, pathMatch: /DUAL FORMS/i }, { key: 'colours', label: 'Choose your 10 colours', choose: 10, pathMatch: /\/COLORS\//i }] },
};
